...
<body>
    <div class=card>
     ...
     <script language="JavaScript">
      ...
      document.getElementById("check-text").onclick = function() {
        const check-text = document.getElementById("check-text");
        if(check-text.style.visibility=="visible"){
           check-text.style.visibility = "hidden";
        }else{
           check-text.style.visibility = "visible"
        }
