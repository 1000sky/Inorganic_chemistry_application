...
<body>
    <div class=card>
     ...
     <ul class="page">
       ...
       <li class="this"><a href="/index4">4</li>
    ...
    <script language="JavaScript">
        ...
        document.getElementById("point").onclick = function() {
          document.getElementById("point-text").innerHTML = "Fe<span class=kasuu>2</span>O<span class=kasuu>3</span>は赤褐色<br>CuOは赤褐色<br>　　の沈殿を作ります。";
