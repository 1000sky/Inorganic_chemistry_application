...
<body>
   ...
   <script language="JavaScript">
    ...
    document.getElementById("point").onclick = function() {
      document.getElementById("point-text").innerHTML = "強酸塩である塩化物は本来,水に溶けやすいです。<br>Pb<span class=ion>2+</span>Ag<span class=ion>+</span>Hg<span>2</span><span class=ion>2+</span>があると沈殿します。";
