...
<body>
    ...
    <script language="JavaScript">
        ...
        document.getElementById("flame-reaction").onclick = function() {
          document.getElementById("flame-reaction2").innerHTML = 
          "<div class=flame-reaction3> Li <div class=circle-Li></div>  Na <div class=circle-Na></div> K<div class=circle-Na></div> </div>  <br><div class=circle-Li></div>       </div>";
