    ...
    <script language="JavaScript">
        ...
        document.getElementById("flame-reaction").onclick = function() {
          ...
          <div class=flame-reaction3>
            <p>炎色反応</p><br>  
            <div class=set>  Li  <div class=circle-Li></div>  
            <div class=set>  Na  <div class=circle-Na></div>  
            <div class=set>  K   <div class=circle-K></div> 
            <div class=set>  Cu  <div class=circle-Cu></div>  
            <div class=set>  Ca  <div class=circle-Ca></div>  
            <div class=set>  Sr  <div class=circle-Sr></div> 
            <div class=set>  Ba  <div class=circle-Ba></div>  
            </div> 
            ";
