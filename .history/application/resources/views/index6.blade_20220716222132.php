...
<body>
    ...
    <script language="JavaScript">
        ...
        document.getElementById("point").onclick = function() {
          document.getElementById("point-text").innerHTML = "Cu(OH)<span class=kasuu>2</span> は青白色<br>Fe(OH)<span class=kasuu>2</span>は緑白色<br>Fe(OH)<span class=kasuu>3</span>は赤褐色<br>の沈殿を作ります。<br>S<span class=ion>2-</span>があると沈殿します。";
